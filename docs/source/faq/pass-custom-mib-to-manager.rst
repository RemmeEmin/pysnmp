...
.. literalinclude:: /../../examples/hlapi/asyncio/sync/manager/cmdgen/custom-asn1-mib-search-path.py
   :start-after: """#
   :language: python
...
:download:`Download</../../examples/hlapi/asyncio/sync/manager/cmdgen/custom-asn1-mib-search-path.py>` script.
