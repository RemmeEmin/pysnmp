...
.. literalinclude:: /../../examples/hlapi/asyncio/sync/manager/cmdgen/v1-get.py
   :start-after: """#
   :language: python

:download:`Download</../../examples/hlapi/asyncio/sync/manager/cmdgen/v1-get.py>` script.
...
.. literalinclude:: /../../examples/hlapi/asyncio/sync/agent/ntforg/default-v1-trap.py
   :start-after: """#
   :language: python

:download:`Download</../../examples/hlapi/asyncio/sync/agent/ntforg/default-v1-trap.py>` script.

Many ASN.1 MIB files could be downloaded from
`mibs.snmplabs.com <https://pysnmp.github.io/mibs/asn1/>`_ or PySNMP could
